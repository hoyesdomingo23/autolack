...
import "./ProductoPoliester.css"; // Archivo de estilos
import Header from "../../header/Header";
import Footer from "../../footer/Footer";

const ProductoPoliester = () => {
  // Llama a los Hooks en el nivel superior
  const { nombre } = useParams();

  // Busca el producto seleccionado
  const productoSeleccionado = datosProductosPoliester.find(
...
export default ProductoPoliester;
