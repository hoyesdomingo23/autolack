...
const Lineas = () => {
  ...
  const [mostrarOpciones, setMostrarOpciones] = useState(false); // Controla la visibilidad del menú desplegable
  ...
  const manejarOrden = (tipoOrden) => {
    ...
    setMostrarOpciones(false); // Oculta el menú desplegable después de seleccionar
  };
