...
import "./ProductoMonocomponentes.css"; // Archivo de estilos
import Header from "../../header/Header";
import Footer from "../../footer/Footer";

const ProductoMonocomponentes = () => {
  // Llama a los Hooks en el nivel superior
  const { nombre } = useParams();

  // Busca el producto seleccionado
  const productoSeleccionado = datosProductoMonocomponentes.find(
...
export default ProductoMonocomponentes;
