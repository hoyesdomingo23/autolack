...
const Colores = () => {
  ...
  return (
    <>
      <Header />
      <section className="contenedor-todo-el-form-colores">
        <h2>Por favor inicie sesion para continuar</h2>
        <div className="contenedor-sesion-colores">
          <div className="izquierda-sesion-colores">
            <form className="formulario-colores" onSubmit={handleSubmit}>
              <div className="bloque-input-colores">
                <input
                  className="input-usuario-colores"
                  type="text"
                  id="email-colores"
                  placeholder="Usuario"
                  value={email}
                  ...
                  required
                />
                <label htmlFor="email-colores"></label>
              </div>
              <div className="bloque-input-colores">
                <input
                  className="input-contraseña-colores"
                  type="password"
                  id="pass-colores"
                  ...
                  required
                />
                <label htmlFor="pass-colores"></label>
              </div>
              <div className="bloque-acciones-colores">
                <span className="olvido-contraseña-colores">
                  <a href="#">Olvidaste tu contraseña?</a>
                </span>
                <button className="boton-enviar-colores" type="submit">
                  Submit
                </button>
              </div>
            </form>
          </div>
          <div className="derecha-sesion-colores">
            <div className="imagen-sesion-colores">
              <svg
